...
{
    public class Asansor0 : Asansor // Asansor abstract class'ından inheritance alıyoruz
    {
        ...
        public Asansor0(string asansorAdi)
        {
            asansorAd = asansorAdi; //Asansor adını verilen parametreye eşitliyoruz
        }
        ...
        public void HedefeGotur() //Müşterileri katlara götüren method
        {
            ...
            if (binenler.Count > 0) //Eğer binenler listemiz boş değilse bu block çalışır
            {
                ...
                //Sadece bu asansöre özel, yolcu bıraktığı katta tekrar yolcu alır
                switch (destination)
                {
                    case 1: // Eğer asansör 1.katta ise birinci kat kuyruğundan müşteri alır
                        MusteriAl(Cikis.birinciKat);
                        break;
                    case 2:// Eğer asansör 2.katta ise ikinci kat kuyruğundan müşteri alır
                        MusteriAl(Cikis.ikinciKat);
                        break;
                    case 3:// Eğer asansör 3.katta ise üçüncü kat kuyruğundan müşteri alır
                        MusteriAl(Cikis.ucuncuKat);
                        break;
                    case 4:// Eğer asansör 4.katta ise dördüncü kat kuyruğundan müşteri alır
