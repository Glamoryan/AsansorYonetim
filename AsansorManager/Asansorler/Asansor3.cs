...
{
    public class Asansor3:Asansor //Asansör abstract class'ında inheritance alan class
    {
        ...
        public Asansor3(string asansorAdi)
        {
            asansorAd = asansorAdi; //Parametreyle gelen değeri asansör adına atıyoruz
        }
